...
#OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-grpo_2048-${START_TIME_STR}-${HOSTNAME_S}"  # NOTE neither timestamp nor hostname works with preemptable queue
OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-grpo_2048"  # NOTE neither timestamp nor hostname works with preemptable queue
...
cmd="$cmd --log_completions True"  # default: False. GRPO 2048 default for q34b
