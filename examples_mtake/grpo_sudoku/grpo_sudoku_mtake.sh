...
#ENV_HOST=https://openenv-sudoku.hf.space  # this is default. unreachable from bv
...
#OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-grpo_sudoku-${START_TIME_STR}-${HOSTNAME_S}"  # NOTE neither timestamp nor hostname works with preemptable queue
OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-grpo_sudoku"  # NOTE neither timestamp nor hostname works with preemptable queue
...
# See https://github.com/mtake/trl/blob/main/examples/grpo_sudoku/grpo_sudoku.py
# @@@ahoaho XXX
...
# @@@ahoaho 独自
# Environment
#cmd="$cmd --env_host https://openenv-sudoku.hf.space"
