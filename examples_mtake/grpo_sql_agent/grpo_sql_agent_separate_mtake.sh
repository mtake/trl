...
# @@@ahoaho XXX ???
# TOOLS="query_biogrid"
TOOLS="grpo_sql_agent_separate_lib.query_biogrid"

# @@@ahoaho XXX ???
# REWARD_FUNCS="correctness_reward structure_reward query_reward"
REWARD_FUNCS="grpo_sql_agent_separate_lib.correctness_reward grpo_sql_agent_separate_lib.structure_reward grpo_sql_agent_separate_lib.query_reward"
...
#OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-grpo_sql_agent_separate-${START_TIME_STR}-${HOSTNAME_S}"  # NOTE neither timestamp nor hostname works with preemptable queue
OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-grpo_sql_agent_separate"  # NOTE neither timestamp nor hostname works with preemptable queue
