...
DATASET=zragrtrvr.v4.0528-SFT.yaml
...
ACCELERATE_CONFIG=accelerate_configs/zero3_1node_4proc.yaml  # SFT(jfe) OK for g338b, DPO(rtrvr) OK for q205b, g338b, g4m, g4hm, g4ht dtype=bfloat16, DPO(rtrvr) CUDA OOM for g4hs dtype=bfloat16, DPO(rtrvr) OK for g418b dtype=bfloat16 per_device_train_batch_size=1 gradient_accumulation_steps=1, SFT(rtrvr.v2) CUDA OOM for g418b dtype=bfloat16, per_device_train_batch_size=16, max_length=8192, SFT(rtrvr.v2) OK for g418b dtype=bfloat16, per_device_train_batch_size=8, max_length=8192, SFT(rtrvr.v3) CUDA OOM for g418b dtype=bfloat16, per_device_train_batch_size=8, max_length=8192, SFT(rtrvr.v3) CUDA OOM for g418b dtype=bfloat16, per_device_train_batch_size=4, max_length=8192, SFT(rtrvr.v3) OK for g418b dtype=bfloat16, per_device_train_batch_size=2, max_length=8192
...
####cmd="$cmd --per_device_train_batch_size 8"  # default: 8  # SFT(rtrve.v2) OK for g418b per_device_train_batch_size=8, max_length=8192, SFT(rtrve.v3) CUDA OOM for g418b per_device_train_batch_size=8, max_length=8192
#cmd="$cmd --per_device_train_batch_size 4"  # default: 8  # SFT(rtrve.v2) OK for g4130b per_device_train_batch_size=4, max_length=8192, SFT(rtrve.v3) CUDA OOM for g418b per_device_train_batch_size=4, max_length=8192
cmd="$cmd --per_device_train_batch_size 2"  # default: 8  # SFT(rtrve.v3) OK for g418b per_device_train_batch_size=2, max_length=8192
...
cmd="$cmd --max_length 8192"  # default: 1024  # SFT(rtrve.v2) OK for g418b per_device_train_batch_size=8, max_length=8192, SFT(rtrve.v2) OK for g4130b per_device_train_batch_size=4, max_length=8192, SFT(rtrve.v3) CUDA OOM for g418b per_device_train_batch_size=8, max_length=8192, SFT(rtrve.v3) CUDA OOM for g418b per_device_train_batch_size=4, max_length=8192, SFT(rtrve.v3) OK for g418b per_device_train_batch_size=2, max_length=8192
