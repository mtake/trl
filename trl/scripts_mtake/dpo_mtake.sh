...
####MODEL=trainer_output/granite-4.1-8b-zragrtrvr.v3.0513-SFT-sft-20260513-110924-p5-r16-n2-g418b-3epochs-8192length-rtrvr.v3-0513
####MODEL=trainer_output/granite-4.1-8b-zragrtrvr.v4.0528-SFT-sft-20260529-055302-p2-r10-n2-g418b-3epochs-8192length-rtrvr.v4-0528
...
#OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-dpo-${START_TIME_STR}-${HOSTNAME_S}"  # NOTE neither timestamp nor hostname works with preemptable queue
OUTPUT_DIR="trainer_output/${MODEL##*/}${_DATASET_S}-dpo"  # NOTE neither timestamp nor hostname works with preemptable queue
