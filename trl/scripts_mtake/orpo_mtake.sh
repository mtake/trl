...
#OUTPUT_DIR="trainer_output/${MODEL##*/}-${DATASET_S}-orpo-${START_TIME_STR}-${HOSTNAME_S}"  # NOTE neither timestamp nor hostname works with preemptable queue
OUTPUT_DIR="trainer_output/${MODEL##*/}-${DATASET_S}-orpo"  # NOTE neither timestamp nor hostname works with preemptable queue
